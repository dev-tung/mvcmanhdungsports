                ...
                <select class="cmsSlb" name="procat_parent_id" id="">
                    <?php if( !empty( $this->_DATA['procats'] ) ): ?>
                        <?php foreach( $this->_DATA['procats'] as $procat ): ?>
                            <?php $selected = ( $procat['procat_id'] == $this->_DATA['procat']['procat_id'] ) ? 'selected' : ''; ?>
                            <option class="cmsSlbOption" value="" <?php echo $selected; ?>><?php echo $procat['procat_name']?></option>
                        <?php endforeach; ?>
                    <?php endif; ?>
                </select>
            </div>
